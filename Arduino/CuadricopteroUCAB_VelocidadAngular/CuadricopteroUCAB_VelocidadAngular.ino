...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* El procedimiento loop se ejecuta de forma constante e ininterrumpida, y realiza llamados a las rutinas de 
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////      PROCEDIMIENTO PARA LLEVAR A CABO ESTIMACION DE ESTADO, TELEMETRIA  E INICIO PAULATINO DE LOS MOTORES DEL CUADRICOPTERO      /////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
  Se realiza muestreo de los sensores en espera de recibir un comando de encendido de motores desde la PC. En cuanto se encienden los motores se ejecuta una secuencia de encendido
...
void SecuenciaDeInicio()
{
  ...
  //Ciclo para iniciar lentamente los motores, hasta la mitad de la velocidad base de PWM por defecto, con un retardo de 1ms por cada escalon de velocidad.
  //Se ejecuta si y solo si ha sido enviado un mensaje de encendido de motores desde la PC. (modoEjecucion == 'T')
  i = 0;
  if (modoEjecucion != '_')
  {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////      PROCEDIMIENTO PARA LLEVAR A CABO ESTIMACION DE ESTADO, CONTROL Y TELEMETRIA DEL CUADRICOPTERO EN VUELO      /////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* Ciclo que se ejecuta mientras no se envie comando de apagado de los motores (mientras modoEjecucion sea distinto de '_').
   Secuencialmente, se reciben comandos, se estima el estado del cuadricoptero (posicion angular, velocidad angular y altura), se ejecutan los algoritmos PID, se aplican sus salidas a los
   motores, y se envian mensajes de telemetria a la PC.
*/
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////      PROCEDIMIENTO PARA ESTIMAR LA MEDIA DE RUIDO POR CONDICIONES INICIALES DE VOLTAJE Y TEMPERATURA DEL GIROSCOPIO      /////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////      PROCEDIMIENTO PARA ESTIMAR LA MEDIA DE RUIDO POR INCLINACION DEL ACELEROMETRO SOBRE EL CHASIS      /////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////      PROCEDIMIENTO PARA ESTIMAR LA VELOCIDAD ANGULAR, Y LA POSICION ANGULAR MEDIANTE FILTRO COMPLEMENTARIO      /////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* El procedimiento FiltroComplementario() adquiere datos desde el acelerometro y el giroscopio, los somete a filtrado por medias moviles, y calcula la posicion angular del
   cuadricoptero en Yaw, Pitch y Roll mediante filtro complementario. Se maneja estrictamente la frecuencia de muestreo de los sensores a la hora de muestrear los datos y
   filtrar los datos.
*/
