...
(cl:defmethod cl:initialize-instance :after ((m <ComandoMovimiento>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ComandoMovimiento)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comunicacion_serial-msg:<ComandoMovimiento> is deprecated: use comunicacion_serial-msg:ComandoMovimiento instead.")))

(cl:ensure-generic-function 'comandoPitch-val :lambda-list '(m))
(cl:defmethod comandoPitch-val ((m <ComandoMovimiento>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comunicacion_serial-msg:comandoPitch-val is deprecated.  Use comunicacion_serial-msg:comandoPitch instead.")
  (comandoPitch m))

(cl:ensure-generic-function 'comandoRoll-val :lambda-list '(m))
(cl:defmethod comandoRoll-val ((m <ComandoMovimiento>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comunicacion_serial-msg:comandoRoll-val is deprecated.  Use comunicacion_serial-msg:comandoRoll instead.")
  (comandoRoll m))

(cl:ensure-generic-function 'comandoAltura-val :lambda-list '(m))
(cl:defmethod comandoAltura-val ((m <ComandoMovimiento>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader comunicacion_serial-msg:comandoAltura-val is deprecated.  Use comunicacion_serial-msg:comandoAltura instead.")
  (comandoAltura m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ComandoMovimiento>)))
  ...
  "comunicacion_serial/ComandoMovimiento")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ComandoMovimiento)))
  "Returns string type for a message object of type 'ComandoMovimiento"
  "comunicacion_serial/ComandoMovimiento")
