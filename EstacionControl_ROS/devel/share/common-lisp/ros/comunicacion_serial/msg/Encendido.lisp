...
(cl:defmethod cl:initialize-instance :after ((m <Encendido>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encendido)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name comunicacion_serial-msg:<Encendido> is deprecated: use comunicacion_serial-msg:Encendido instead.")))
